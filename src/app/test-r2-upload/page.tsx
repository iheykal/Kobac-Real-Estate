...
export default function TestR2Upload() {
  ...
  const handleFileUpload = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      formData.append('listingId', 'test-r2-upload');
      ...
      if (data.success) {
        ...
        console.log('✅ R2 upload test successful:', data);
      } else {
        setError(data.error || 'Upload failed');
        console.error('❌ R2 upload test failed:', data);
      }
    } catch (err) {
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="mb-8">
            <p className="text-gray-600 mb-4">
              This test uploads an image to R2 to verify that the upload process is working correctly.
              The image will be automatically converted to WebP format and uploaded to Cloudflare R2.
            </p>
            ...
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">
              ...
              >
                {uploading ? '🔄 Uploading...' : '📸 Choose Image to Test R2 Upload'}
              </label>
            </div>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="p-4 bg-blue-50 rounded-md">
                  <h3 className="font-medium text-gray-900 mb-3">🖼️ Uploaded Files</h3>
                  {result.uploadedFiles.map((file: any, index: number) => (
                    <div key={index} className="space-y-2 text-sm mb-4">
              ...
              <div className="p-4 bg-gray-50 rounded-md">
                <h3 className="font-medium text-gray-900 mb-3">🔍 Test the Uploaded Image</h3>
                <p className="text-sm text-gray-600 mb-2">
                  Click the "View Image" link above to test if the uploaded image is accessible from R2.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
                  <li>• If the image loads: R2 upload is working correctly</li>
                  <li>• If you get a 404 error: The image wasn't uploaded or the URL is wrong</li>
                  <li>• If you get a 403 error: The R2 bucket is private or misconfigured</li>
                </ul>
              </div>
            </div>
          )}
