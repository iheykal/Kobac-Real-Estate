...
export default function FixUrlPathsPage() {
  ...
  const fixUrlPaths = async () => {
    ...
    try {
      const response = await fetch('/api/admin/fix-url-paths', {
        method: 'POST',
        credentials: 'include',
        headers: {
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="space-y-6">
            ...
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <div className="text-sm text-blue-700 space-y-2">
                ...
                <ul className="ml-4 list-disc space-y-1">
                  <li>Find all URLs containing `/uploads/listings/`</li>
                  <li>Replace with `/listings/` (remove the extra `/uploads/`)</li>
            ...
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <h3 className="font-medium text-green-800 mb-3">⚡ Fix URL Paths</h3>
              <button
                onClick={fixUrlPaths}
                disabled={loading}
                className="px-6 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? 'Fixing...' : 'Fix URL Paths'}
              </button>
            </div>
